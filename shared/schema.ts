...
export const connectedAccounts = pgTable("connected_accounts", {
  ...
  originalBio: text("original_bio"),
  originalAvatar: text("original_avatar"),
  modifiedUsername: text("modified_username"),
  modifiedBio: text("modified_bio"),
  profileModified: boolean("profile_modified").notNull().default(false),
